...
sed -i '1i if exist media-autobuild_suite/local64 compact \/C \/S:media-autobuild_suite\/local64' media-autobuild_suite/media-autobuild_suite.bat
sed -i '1i if exist media-autobuild_suite/local64 compact \/C \/S:media-autobuild_suite\/msys64' media-autobuild_suite/media-autobuild_suite.bat
